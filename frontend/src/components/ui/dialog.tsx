      ...
      >
        ...
        {showCloseButton && (
          <DialogPrimitive.Close
            ...
            className="hover:cursor-pointer absolute top-4 right-4 rounded-xs transition-opacity disabled:pointer-events-none [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4"
          >
            <XIcon />
